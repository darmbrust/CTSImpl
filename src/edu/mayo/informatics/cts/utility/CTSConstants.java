...
public class CTSConstants
{
    ...
    public static StringParameter VAPI_SQL_TABLE_PREFIX = new StringParameter("");
    ...
    public static BooleanParameter LUCENE_STEMMED_SEARCH_ENABLED = new BooleanParameter(false);
