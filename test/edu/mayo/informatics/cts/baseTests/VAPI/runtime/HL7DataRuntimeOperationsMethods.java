 ...
 */
public class HL7DataRuntimeOperationsMethods extends TestCase
{
    private RuntimeOperations roi_;

    public HL7DataRuntimeOperationsMethods()
    {
        super();
    }

    public HL7DataRuntimeOperationsMethods(String name, RuntimeOperations roi)
    {
        super(name);
        roi_ = roi;
    }
    ...
    public void testGetSupportedCodeSystems() throws Exception
    {
        ...
        results = roi_.getSupportedCodeSystems(1000, 2);
        assertNotNull(results);
        assertTrue("Did not limit to right count", results.length == 2);
